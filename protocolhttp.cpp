...
bool cIptvProtocolHttp::Connect() {
    debug1("%s", __PRETTY_FUNCTION__);
...
bool cIptvProtocolHttp::Disconnect() {
    debug1("%s", __PRETTY_FUNCTION__);
...
bool cIptvProtocolHttp::GetHeaderLine(char *destP, unsigned int destLenP, unsigned int &recvLenP) {
...
bool cIptvProtocolHttp::ProcessHeaders() {
    debug1("%s", __PRETTY_FUNCTION__);
...
cString cIptvProtocolHttp::GetInformation() {
